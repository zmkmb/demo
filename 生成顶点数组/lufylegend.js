...
var LGlobal = (function() {
    ...
    LGlobal.hitTestPolygonArc = function(vs, arc) {
        ...
        l = vs.length; i < l; i++) {
            ...
            p1 = vs[i],
            p2 = vs[j];
            v1 = new LVec2(arc[0] - p1[0],arc[1] - p1[1]),
            v2 = new LVec2(p2[0] - p1[0],p2[1] - p1[1]);
            l2 = v2.normalize();
            inn = LVec2.dot(v1, l2);
            if (inn <= 0) {
...
var LGraphics = (function() {
    ...
    var p = {
        ...
        clone: function() {
            ...
            a.bitmap = s.bitmap;
            for (i = 0,
            l = s.setList.length; i < l; i++) {
                c = s.setList[i];
                a.setList.push(c);
            }
            for (i = 0,
            l = s.showList.length; i < l; i++) {
                c = s.showList[i];
                a.showList.push(c);
            }
            return a;
        ...
        getWidth: function() {
            ...
            l = s.showList.length; k < l; k++) {
                if (s.showList[k].type == LShape.RECT) {
                    ...
                    for (k1 = 0,
                    l1 = s.showList[k].arg.length; k1 < l1; k1++) {
...
var LSprite = (function() {
    ...
    var p = {
        ...
        stopDrag: function() {
            var s = this, i, l;
            for (i = 0,
            l = LGlobal.dragList.length; i < l; i++) {
...
var LTextField = (function() {
    ...
    var p = {
        ...
        ll_getHtmlText: function(tf, text) {
            ...
            } while (start > 0 && start < end);content = text.substring(text.indexOf(">", arr.index) + 1, end);
